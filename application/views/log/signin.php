  ...
  <body class="app">
    ...
    <div class="peers ai-s fxw-nw h-100vh">
      <div
        ...
        style="background-image: url('img/pitamin_login_cover_3.png'); background-size: cover; background-repeat: no-repeat;
...
<!--        </div>-->
      ...
      <div
        ...
        style="min-width: 320px; background-color: #939196; font-weight: bold"
      >
        <span style="font: bold;">
            <h4 class="fw-300 c-grey-900 mB-40" style="font-weight: bold">Login</h4>
        </span>
